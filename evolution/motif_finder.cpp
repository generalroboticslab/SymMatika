...
// void MotifFinder::find_motifs(std::vector<std::vector<FFPair>> &islands, const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> &numeric_pds, const DataSet &dataset, std::size_t M) {
//     if (M_f.empty() || M_f.size() < var_list.size()) {
//         size_t d = std::max<size_t>(var_list.size(), 10);
//         M_f.resize(d);
//         for (auto &r : M_f) {
//             r.reserve(20);
...
//                             }
//                         }
//                         else if (current->type == NodeType::Function) {
//                             if (current->child) {
...
//                         }
//
//                         RCP<const Basic> b_zero = rcp_static_cast<const Basic>(zero);
//                         RCP<const Basic> b_one = rcp_static_cast<const Basic>(one);
//
//                         if (valid_motif) {
//                             if (current->left && parsimony(current->left) >= 2) {
//                                 try {
//                                     RCP<const Basic> left_exp = tree_to_sym(current->left);
//                                     if (!is_a_Number(*left_exp)) {
//                                         RCP<const Basic> remaining;
//                                         if (current->op == OpType::Add) {
//                                             if (current->right) {
//                                                 remaining = tree_to_sym(current->right);
//                                             } else {
//                                                 remaining = b_zero;
//                                             }
//                                         } else if (current->op == OpType::Subtract) {
//                                             if (current->right) {
//                                                 remaining = neg(tree_to_sym(current->right));
//                                             } else {
//                                                 remaining = b_zero;
//                                             }
//                                         } else if (current->op == OpType::Multiply) {
//                                             if (current->right) {
//                                                 remaining = tree_to_sym(current->right);
//                                             } else {
//                                                 remaining = b_one;
//                                             }
//                                         } else if (current->op == OpType::Divide) {
//                                             if (current->right) {
//                                                 remaining = div(b_one, tree_to_sym(current->right));
//                                             } else {
//                                                 remaining = b_one;
//                                             }
//                                         } else {
...
//                                         }
//
//                                         double remaining_fitness;
//                                         try {
//                                             remaining_fitness = fitness(remaining, dataset, numeric_pds);
//                                         } catch (...) {
//                                             remaining_fitness = std::numeric_limits<double>::lowest();
//                                         }
//
//                                         double f_L_score = (tau_fitness - remaining_fitness);
//                                         if (std::abs(tau_fitness) > 1e-10) {
//                                             f_L_score /= std::abs(tau_fitness);
//                                         }
//
//                                         if (f_L_score > -0.1) {
//                                             local_batch.push_back(Motif(tree, current->left, left_exp, std::abs(f_L_score)));
//                                         }
//                                     }
//                                 } catch (...) {
//                                     continue;
...
//                             }
//
//                             if (current->right && parsimony(current->right) >= 2) {
//                                 try {
//                                     RCP<const Basic> right_exp = tree_to_sym(current->right);
//                                     if (!is_a_Number(*right_exp)) {
//                                         RCP<const Basic> remaining;
//                                         if (current->op == OpType::Add || current->op == OpType::Subtract) {
//                                             if (current->left) {
//                                                 remaining = tree_to_sym(current->left);
//                                             } else {
//                                                 remaining = b_zero;
//                                             }
//                                         } else if (current->op == OpType::Multiply || current->op == OpType::Divide) {
//                                             if (current->left) {
//                                                 remaining = tree_to_sym(current->left);
//                                             } else {
//                                                 remaining = b_one;
...
//                                         }
//
//                                         double f_R_score = (tau_fitness - remaining_fitness);
//                                         if (std::abs(tau_fitness) > 1e-10) {
//                                             f_R_score /= std::abs(tau_fitness);
//                                         }
//
//                                         if (f_R_score > -0.1) {
//                                             local_batch.push_back(Motif(tree, current->right, right_exp, std::abs(f_R_score)));
//                                         }
//                                     }
//                                 } catch (...) {
//                                     continue;
